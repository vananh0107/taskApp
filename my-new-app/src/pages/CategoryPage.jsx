...
import { fetchCategories, createCategory, deleteCategory } from '../actions/categoryActions';
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="overflow-x-auto">
          ...
          {categories.length === 0 && (
            <div className="text-center text-gray-500 mt-4">No categories available.</div>
          )}
        </div>
      </div>
    </div>
